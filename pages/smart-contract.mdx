...
There are many applications of RNG in AElf projects, we choose a code block from BingoGame to do the demostration:
...
The required import in HelloWorld.cs
```sh copy
using AElf.Standards.ACS6;
```
```sh copy
