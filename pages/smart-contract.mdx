...
Enter the params one by one, type `Enter` to skip optional param:
? Enter the required param <proposalId_1>: af5edc00120f127e67b22053c41c257248d952e99d41081612a7fb4c195687df
...
```
$ aelf-command event {transactionId_2}
```
...
Enter the params one by one, type `Enter` to skip optional param:
? Enter the required param <proposalId_2>: 0986fb00120f127e67b22053c41c257248d952e99d41081612a7fb4c195687df
? Enter the required param <proposedContractInputHash>: f2335b7ef35bb1a94c188c0e62206f87491c4a47ac9ddc4b6721556726d092e3
b526b
```
...
```
$ aelf-command event {transactionId_3}
```
